...
export default function Carrinho({ carrinhoItems }) { // Recebe os itens do carrinho como prop
  return (
      ...
      {carrinhoItems && carrinhoItems.length > 0 ? (
        <ul className="list-group">
          ...
          <li className="list-group-item active d-flex justify-content-between align-items-center mt-3">
            <strong>Total:</strong> R$ {carrinhoItems.reduce((acc, item) => acc + item.preco, 0).toFixed(2).replace('.', ',')}
          </li>
        </ul>
      ) : (
